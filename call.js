...
function renderQualLeadHeader(lead) {
  ...
  container.innerHTML = `
    ...
    <div class="qual-last-activity">
      <div class="qual-last-activity-icon">
      ...
      <div class="qual-last-activity-body">
        <div class="qual-last-activity-title">
          Chiamata in uscita
        </div>
        <div class="qual-last-activity-detail">Oggi alle ${new Date().toLocaleTimeString('it-IT', {hour:'2-digit', minute:'2-digit'})} • Durata: ${callTimerSeconds >= 60 ? Math.floor(callTimerSeconds / 60) + ' min ' + (callTimerSeconds % 60) + ' sec' : callTimerSeconds + ' sec'}</div>
      </div>
    </div>
  `;
}
